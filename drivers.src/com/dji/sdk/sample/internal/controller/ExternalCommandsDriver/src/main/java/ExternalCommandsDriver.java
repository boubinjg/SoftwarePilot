 ...
 * @since   2017-05-01
 */
public class ExternalCommandsDriver extends com.dji.sdk.sample.internal.controller.AuavDrivers { //???
 		/**
		 *
		...
		private class ecdResource extends CoapResource { //CoapResource is a basic implementation of a resource
				...
				public void handlePUT(CoapExchange ce) { //The Class CoapExchange represents an exchange of a CoAP request and response
						...
						if (driverName.equals("add")) {
								...
								com.dji.sdk.sample.internal.controller.AuavRoutines ar = null;
								try {
										ar=(com.dji.sdk.sample.internal.controller.AuavRoutines)(Class.forName(routineName).newInstance());
								}
