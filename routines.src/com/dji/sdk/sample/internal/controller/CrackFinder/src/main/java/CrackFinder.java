 ...
 * @since   2018-6-25
 */
public class CrackFinder extends org.reroutlab.code.auav.routines.AuavRoutines {
		/**
	...
	static byte[] pic;
        ...
        static int[] Rmoves = {1,1,1}; //Comple/mentary set of three moves i.e Right, Down and Backward
