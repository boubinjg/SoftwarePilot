 ...
 * @since   2020-06-18
 */
public class WaypointMissionTest extends com.dji.sdk.sample.internal.controller.AuavRoutines {
		/**
...
**/
		...
		public void run() {
            ...
            succ = invokeDriver("com.dji.sdk.sample.internal.controller.MissionDriver","dc=initWaypoint", auavResp.ch);
...
//          succ = invokeDriver("org.reroutlab.code.auav.drivers.MissionDriver","dc=uploadMission", auavResp.ch);
            ...
            succ = invokeDriver("com.dji.sdk.sample.internal.controller.MissionDriver","dc=uploadMission", auavResp.ch);
			auavSpin();
            System.out.println("#####################Uploaded a mission#####################################");

            //start the mission
            auavLock("Start");
            succ = invokeDriver("org.reroutlab.code.auav.drivers.MissionDriver","dc=startMission", auavResp.ch);
			auavSpin();
            System.out.println("#####################Started a mission#####################################");
            //take picture and pause mission
            //takeImg();
            auavLock("Pause");
            succ = invokeDriver("org.reroutlab.code.auav.drivers.MissionDriver","dc=pauseMission", auavResp.ch);
			auavSpin();
            System.out.println("#####################Pasued a mission#####################################");

			//stop the mission
            auavLock("stop");
            succ = invokeDriver("org.reroutlab.code.auav.drivers.MissionDriver","dc=stopMission", auavResp.ch);
			auavSpin();
